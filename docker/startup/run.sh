...
python /code/webapp/manage.py migrate --settings=webapp.env.local_settings
python /code/webapp/manage.py loaddata --settings=webapp.env.local_settings initial_user
python /code/webapp/manage.py collectstatic --no-input
...
python /code/webapp/manage.py runserver 0.0.0.0:8000 --settings="webapp.env.local_settings"
