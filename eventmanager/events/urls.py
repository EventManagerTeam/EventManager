...
urlpatterns = [
	path('search_json/<int:category_id>/<slug:slug>', views.search_json, name='events.search_json'),
	path('search_json/<int:category_id>/', views.search_json, name='events.search_json'),
